...
const NavbarHeader = () => {
    ...
    return (
        <div className='flex items-center flex-row justify-center h-[110px] max-sm:gap-4 sm:hidden'>
    ...
    <div className='relative'>
                        <input 
                            ...
                            className='w-[214px] h-[29px] pl-10 pr-10 bg-gray-200 rounded-[11px] border border-black text-zinc-500 text-xs font-medium placeholder:indent-[0.3rem] indent-[0.3rem] font-["inter"]'
                        />
