...
const Signup = () => {
    ...
    return (
        <div className='h-screen w-full'>
            <div className='h-screen flex flex-col justify-center items-center sm:gap-7'>
                <div>
                ...
                <div className='flex flex-col sm:gap-7 gap-4'>
                    ...
                    <input type="text" className="sm:w-[520px] sm:h-[62px] w-[263px] h-[51.10px] rounded-[9px] bg-white bg-opacity-50 sm:rounded-[15px] border border-black backdrop-blur-[22px] sm:indent-[3.5rem] placeholder:text-neutral-500 sm:text-[16px] text-xs indent-[1.6rem] font-normal font-['Montserrat']" placeholder='Enter your full name' value={name} onChange={(e) => setName(e.target.value)} required/>

                    <input type="email" className="sm:w-[520px] sm:h-[62px] w-[263px] h-[51.10px] rounded-[9px] bg-white bg-opacity-50 sm:rounded-[15px] border border-black backdrop-blur-[22px] sm:indent-[3.5rem] placeholder:text-neutral-500 sm:text-[16px] text-xs indent-[1.6rem] font-normal font-['Montserrat']" placeholder='Enter your email' value={email} onChange={(e) => setEmail(e.target.value)} required/>

                    <input type="number" className="sm:w-[520px] sm:h-[62px] w-[263px] h-[51.10px] rounded-[9px] bg-white bg-opacity-50 sm:rounded-[15px] border border-black backdrop-blur-[22px] sm:indent-[3.5rem] placeholder:text-neutral-500 sm:text-[16px] text-xs indent-[1.6rem] font-normal font-['Montserrat'] appearance-none" placeholder='Enter phone no' value={phone} onChange={(e) => setPhone(e.target.value)} required/>
                ...
                <div className='max-sm:mt-8'>
                    <span className="text-neutral-500 sm:text-[14px] text-xs font-normal font-['Poppins']">
                        Already have an account ?</span><span className="text-violet-600 sm:text-[14px] text-xs font-normal font-['Poppins']">
